        ...
        children: [
            {
                path: '/index',
                name: 'index',
                redirect: {name: 'dir-prompts-info'},
                //component: () => import('@/layout/index.vue'),
                meta: {
                    cache: true,
                    title: '首页',
            ...
            // },
            {
                ...
                children: [
                    {
                        path: '/dir-prompts-info',
                        name: 'dir-prompts-info',
                        meta: {
                            title: 'Prompts管理',
                            icon: 'yonghuguanli',
                            requiresAuth: true,
                        ...
                        component: () => import('@/views/sys/prompt/dir-prompts-info.vue'),
                    },
                    {
                        path: '/get-checklist',
                        name: 'get-checklist',
                        ...
                        component: () => import('@/views/sys/checklist/get-checklist.vue'),
                    },
                    {
                        path: '/get-feedback',
                        name: 'get-feedback',
                        ...
                        component: () => import('@/views/sys/feedback/get-feedback.vue'),
                    },
                    {
                        path: '/dir-uploads-info',
                        name: 'dir-uploads-info',
                        meta: {
                            title: '文档处理',
                            icon: 'pdf',
                            requiresAuth: true,
                        ...
                        component: () => import('@/views/sys/uploads/dir-uploads-info.vue'),
                    },
                    {
                        path: '/dir-adobe-info',
                        name: 'dir-adobe-info',
                        ...
                        component: () => import('@/views/sys/adobe/dir-adobe-info.vue'),
                    },
                    {
                        path: '/dir-users-info',
                        name: 'dir-users-info',
